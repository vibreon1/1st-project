...
const Data = () => {
    return(
        <div className="home__data">
            <h1 className="home__title">Rahul
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm an Indian-born creative designer who is devoted to what I do.</p>

            <a href="#contact" className="button buttton--flex">
                say hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
