...
const Contact = () =>{
    return(
        <section className="Contact seection" id="contact">
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">rahulkumar6259@gmail.com</span>
                        ...
                        <i class="bx bxl-whatsapp contact__card-icon" ></i>
                            ...
                            <span className="contact__card-data">8789883566</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">vibreon</span>
